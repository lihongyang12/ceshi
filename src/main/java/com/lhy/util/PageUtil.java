...
public class PageUtil {
	...
	public PageUtil(String page, int pageSize, int count) {
		...
		//处理尾页
		this.lastPage = (int)Math.ceil((double)count/pageSize);
		...
		//结束索引
		this.endIndex = this.currentPage * pageSize;
	}
	public PageUtil() {
		super();
	...
	public String toString() {
		return "PageUtil [page=" + page + ", pageSize=" + pageSize + ", count=" + count + ", prevPage=" + prevPage
				+ ", nextPage=" + nextPage + ", currentPage=" + currentPage + ", lastPage=" + lastPage + ", startIndex="
